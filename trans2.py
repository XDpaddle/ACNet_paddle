...
parser.add_argument('-opt', type=str, help='Path to options YMAL file.', default="config/train/train_acnet_x4.yml")
...
paddle.save(ckpt_pd, 'trans_weights\\trans_acnet_x4_660000.pdparams')
a = 1